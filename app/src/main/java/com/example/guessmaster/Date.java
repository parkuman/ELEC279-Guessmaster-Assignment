 ...
 * ELEC 279 Assignment 2: March 2020 
 */
...
public class Date {
	...
	/**
	 * Method created for Assignment, takes a string, date, as input and parses it
	 * from MM/DD/YYYY format and passes respective months days and years into the
	 * setDate method
	 * 
	 * @param date Input string in the format of MM/DD/YYYY
	 * @author Parker Rowe
	 */
	public Date(String date) {
		// dateArray is an array of strings that holds the monthstring in 0, daystring
		// in 1, and yearstring in 2
		String[] dateArray = date.split("/");
		// call setDate passing it 3 parsed integer values from the dateArray array
